...
---
***Conferences***
* N. Kota(#), A. Mishra(#), S.Srinivasa(#), X. Chen and P. Abbeel., "***A K-fold Method for Baseline Estimation in Policy Gradient Algorithms***,"NIPS Deep Reinforcement Learning Workshop, 2016, [[pdf]](https://arxiv.org/pdf/1701.00867.pdf){:target="_blank"} (#: equal contribution)
* A. Malipatil, M. Mobin, A. Nayak, S. Srinivasa, and H. Xia, "***SerDes steady state adaptation challenges over PVT in existing SAS/SATA and emerging PCIe Gen4/SAS4 application and their solutions with real time pattern discriminator constrained adaptation***,", DesignCon 2015. (# all the authors contributed equally) [[pdf]](https://designcon.tech.ubm.com/eventAssets/descon_all_Proceedings_150202154121/files/DC15%20Paper%20Titles.pdf){:target="_blank"}
...
* R. K. Ganti, Z. Gong, M. Haenggi, C.-H. Lee, S. Srinivasa, D. Tisza, S. Vanka, and P. Vizi, "***Implementation and Experimental Results of Superposition Coding on Software Radio***," in 2010 IEEE International Conference on Communications (ICC'10), (Cape Town, South Africa), May 2010. [[pdf]]({{site.baseurl}}/assets/publications/10ICC.pdf){:target="_blank"} (# all the authors contributed equally.)
* S. Srinivasa and S. Krishnamurthy, “***An Opportunistic Forwarding Protocol for Intermittently Connected
Environments***,” IEEE Communications Society Conference on Sensor, Mesh and Ad Hoc Communications and
Networks (SECON), June 2009. [[pdf]]({{site.baseurl}}/assets/publications/09SECON.pdf){:target="_blank"}
